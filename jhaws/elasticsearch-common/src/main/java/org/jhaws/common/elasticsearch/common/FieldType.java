 ...
 * <br>
 * <b>long</b>: A signed 64-bit integer with a minimum value of -2<sup>63</sup>
 * and a maximum value of 2<sup>63-1</sup>.<br>
 * <b>integer</b>: A signed 32-bit integer with a minimum value of
 * -2<sup>31</sup> and a maximum value of 2<sup>31-1</sup>.<br>
 * <b>short</b>: A signed 16-bit integer with a minimum value of -32,768 and a
 * maximum value of 32,767.<br>
 * <b>byte</b>: A signed 8-bit integer with a minimum value of -128 and a
 * maximum value of 127.<br>
 * <b>double</b>: A double-precision 64-bit IEEE 754 floating point number,
 * restricted to finite values.<br>
 * <b>float</b>: A single-precision 32-bit IEEE 754 floating point number,
 * restricted to finite values.<br>
 * <b>half_float</b>: A half-precision 16-bit IEEE 754 floating point number,
 * restricted to finite values.<br>
 * <b>scaled_float</b>: A floating point number that is backed by a long, scaled
 * by a fixed double scaling factor.<br>
 * <br>
 * <table border=1>
 * <tr>
 * <td>Type</td>
 ...
 * </table>
 * <br>
 * <b><font color=purple>numerische types zijn beter voor range queries, keyword
 * is beter voor term queries ed. en zijn ook over het algemeen sneller</font>,
 * gebruik een 'multi field' als je niet zeker bent</b><br>
 * <br>
 ...
 * <b>coerce</b><br>
 * default true, Try to convert strings to numbers and truncate fractions for
 * integers, enkel voor numerische velden<br>
 * 
...
public enum FieldType {
	...
	TEXT_VECTOR_POSITIONS_OFFSETS("text",
			java.util.Collections.singletonMap("term_vector", TermVector.with_positions_offsets.name())), //
	TEXT_VECTOR_PAYLOADS("text",
			java.util.Collections.singletonMap("term_vector", TermVector.with_positions_payloads.name())), //
	TEXT_VECTOR_POSITIONS_OFFSETS_PAYLOADS("text",
			java.util.Collections.singletonMap("term_vector", TermVector.with_positions_offsets_payloads.name())), //
	/**
	...
	KEYWORD("keyword"), //
	/**
	 * <b>format</b>: bv. "format": "strict_date_optional_time||epoch_millis",
	 * "yyyy-MM-dd HH:mm:ss||yyyy-MM-dd"<br>
	 * <b>store</b> (false)<br>
	 * <b>locale</b><br>
	 * 
	...
	/**
	 * scaled_float heeft een scaling_factor dus speciefieke implemetaties zijn
	 * enkel mogelijk<br>
	 * <b>store</b> (false)<br>
	 * 
	 * @see https://www.elastic.co/guide/en/elasticsearch/reference/current/number.html
