...
public class EncodingInfo {
	...
	static {
		EncodingInfo.encodingList.add(new EncodingInfo(null, "UTF-32, big-endian", new String(new byte[] { 0, 0, -2, -1 }))); // not supported by java, will throw //$NON-NLS-1$
																																// UnsupportedEncodingException
		EncodingInfo.encodingList.add(new EncodingInfo(null, "UTF-32, little-endian", new String(new byte[] { 0, 0, -1, -2 }))); // not supported by java, will throw //$NON-NLS-1$
																																	// UnsupportedEncodingException
		...
		EncodingInfo.encodingList.add(new EncodingInfo("US-ASCII", "unknown (binary)", "")); // must be added as last //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
	 ...
	 * 
	 * @param bomBuffer
	 *            : byte[] : first bytes read from file
	 * 
	 ...
	 * 
	 * @param bomBuffer
	 *            : char[] : first bytes read from file as a char array
	 * 
	 * @return : EncodingInfo : appropriate encoding info
	 */
	 ...
	 * 
	 * @param bom
	 *            : String : first bytes read from file as a string
	 * 
	 * @return : EncodingInfo : appropriate encoding info
	 */
