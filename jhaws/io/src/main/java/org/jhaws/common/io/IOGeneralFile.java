...
public class IOGeneralFile<T extends IOGeneralFile<T>> extends File {
	 ...
	 * @param conversion : int : use BYTE_TO_KiloByte, BYTE_TO_MegaByte,
	 ...
	 *
	 * @param file : File : file
	 * @param parameter : int : use FileConv.EVERYWHERE, FileConv.CLASSPATH_ONLY
	 * or FileConv.LIBRARYPATH_ONLY
	 *
	 * @return : boolean : exists or not
	 */
	 ...
	 * @param os : int : operating system, use FileConv.WIN32, FileConv.DOS,
	 * FileConv.UNIX
	 *
	 ...
	 *
	 * @param file : String : file name without path
	 * @param parameter : int : file name with path where first found,
	 * EVERYWHERE, CLASSPATH_ONLY, LIBRARYPATH_ONLY
	 *
	 * @return : IOFile : IOFile file or <i>null</i> when not found
	 */
	...
	protected static final String[] overwriteOptions = new String[] { "yes", //$NON-NLS-1$
			"no", //$NON-NLS-1$
	 ...
	 * Creates a new IOGeneralFile object.
	 *
	 * @param pathname : String : full path name of file or directory; when only
	 * a name is given, the file or directory will be in the current working
	 * directory
	 */
