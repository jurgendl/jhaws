...
public class FilePath implements Path, Externalizable {
        ...
        public static class ImageFilter extends Filters.ExtensionFilter {
            public ImageFilter() {
                super("jpg", "jpeg", "bmp", "tiff", "tif", "pix", "png", "gif", "jp2", "tga", "pcx", "pnm", "ppm", "pbm", "pgm", "ras", "iff", "raw",
                        "jpe", "wmf", "svg", "jpm", "emf", "rla", "jif", "dpx", "dcx", "pic", "ico", "webp");
            }
        }
    ...
    protected static FilePath newFileIndex(Path parent, String outFileName, String sep, String format, String extension) {
        ...
        while (file.exists()) {
            ...
            if (extension.equals("")) {
                ...
                file = new FilePath(parent, outFileName.substring(0, outFileName.length() - FORMAT.length()) + SEPARATOR + indStringSB.toString()
                        + getFileExtensionSeperator() + extension);
            }
            ind++;
        }
        return file;
    ...
    public FilePath process(Predicate<String> isGroup, UnaryOperator<String> groupBuilder, Predicate<String> acceptGroup,
