 ...
 * signed integer, this string will be replaced by a signed integer with the value of the lenght of the filename String minus the value of
 * 'number'<br>
 * <br>
