...
public class Processes {
    ...
    @SafeVarargs
    public static <C extends Consumer<String>> C callProcess(Value<Process> processHolder, boolean throwExitValue, List<String> command, FilePath dir,
            C consumer, Consumer<String>... consumers) throws UncheckedIOException {
        return callProcess(processHolder, throwExitValue, null, new HashMap<>(), command, dir, null, null, consumer, consumers);
    }

    @SafeVarargs
    public static <C extends Consumer<String>> C callProcess(Value<Process> processHolder, boolean throwExitValue, FilePath input,
            Map<String, String> env, List<String> command, FilePath dir, FilePath outputLog, FilePath errorLog, C consumer,
            Consumer<String>... consumers) throws UncheckedIOException {
        if (dir == null)
        ...
        try {
            ...
            if (processHolder != null) processHolder.set(process);
        ...
        try {
            ...
            if (exitValue != 0 && throwExitValue) throw new ExitValueException(exitValue);
