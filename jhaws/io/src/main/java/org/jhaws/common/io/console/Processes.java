...
public class Processes {
    ...
    @SafeVarargs
    public static <C extends Consumer<String>> C callProcess(boolean throwExitValue, List<String> command, FilePath dir, C consumer,
    ...
    @SafeVarargs
    public static <C extends Consumer<String>> C callProcess(boolean throwExitValue, FilePath input, Map<String, String> env, List<String> command,
            FilePath dir, FilePath outputLog, FilePath errorLog, C consumer, Consumer<String>... consumers) throws UncheckedIOException {
        if (dir == null)
