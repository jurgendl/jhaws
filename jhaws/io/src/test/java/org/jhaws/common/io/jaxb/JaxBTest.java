...
public class JaxBTest {
    ...
    public void testType() {
        ...
        pom = j.unmarshall(Pom.class, new FilePath("pom.xml").getPath());
        System.out.println(pom.getVersion() == null ? null : pom.getVersion().getVersion());
        System.out.println(pom.getParent() == null ? null : pom.getParent().getVersion().getVersion());

        pom = j.unmarshall(null, new FilePath("pom.xml").getPath());
        System.out.println(pom.getVersion() == null ? null : pom.getVersion().getVersion());
        System.out.println(pom.getParent() == null ? null : pom.getParent().getVersion().getVersion());

        pom = (Pom) j.unmarshall(Object.class, new FilePath("pom.xml").getPath());
        System.out.println(pom.getVersion() == null ? null : pom.getVersion().getVersion());
        System.out.println(pom.getParent() == null ? null : pom.getParent().getVersion().getVersion());
