...
public class CheckCookiesEnabled extends Panel {
	public static JavaScriptResourceReference JS = new JavaScriptResourceReference(CheckCookiesEnabled.class,
			"CheckCookiesEnabled.js");
	...
	public CheckCookiesEnabled() {
		...
		cookiesQ.setVisible(WicketApplication.get().getSettings().isCheckCookiesEnabled()
				&& WicketSession.get().getCookies().getUserAllowedCookies() == null);
		add(cookiesQ);
	}
	...
	public void renderHead(IHeaderResponse response) {
		...
		if (WicketApplication.get().getSettings().isCheckCookiesEnabled()
				&& WicketSession.get().getCookies().getUserAllowedCookies() == null) {
