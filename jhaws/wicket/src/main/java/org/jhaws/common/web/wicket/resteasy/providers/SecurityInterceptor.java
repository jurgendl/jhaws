package org.jhaws.common.web.wicket.resteasy.providers;
...
public class SecurityInterceptor implements javax.ws.rs.container.ContainerRequestFilter {
    ...
    protected static final ServerResponse ACCESS_DENIED = new ServerResponse("Access denied for this resource", 401, new Headers<>());;

    protected static final ServerResponse ACCESS_FORBIDDEN = new ServerResponse("Nobody can access this resource", 403, new Headers<>());;

    protected static final ServerResponse SERVER_ERROR = new ServerResponse("INTERNAL SERVER ERROR", 500, new Headers<>());;
