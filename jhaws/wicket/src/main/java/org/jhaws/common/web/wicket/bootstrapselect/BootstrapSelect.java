...
public class BootstrapSelect {
	public static final JavaScriptResourceReference JS = new JavaScriptResourceReference(BootstrapSelect.class,
			"js/bootstrap-select.js");

	public static final CssResourceReference CSS = new CssResourceReference(BootstrapSelect.class,
