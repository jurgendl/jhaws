...
public abstract class AbstractFormElementSettings<T extends AbstractFormElementSettings<T>>
	...
	protected boolean skipForExport(String propertyName) {
		return "required".equals(propertyName) || "showPlaceholder".equals(propertyName)
				|| "inheritId".equals(propertyName);
	}
