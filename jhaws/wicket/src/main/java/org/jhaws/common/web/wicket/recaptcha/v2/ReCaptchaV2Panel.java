 ...
 * zet sitekey en secret dmv Spring (OPGELET ReCaptchaV2Panel.visible=true/false hebben andere sitekey/secret)<br>
 ...
 * error(new ResourceModel("recaptcha.failed").wrapOnAssignment(ContactPage.this).getObject());<br>
 * return;<br>
 * }<br>
 * }<br>
 * <br>
 * form.add(recaptcha);<br>
 * form.add(recaptcha.getReCaptcha().nonAjaxReCaptchaSubmit(new SubmitLink("submitform", form)));<br>
 * <br>
 * [B] in code ajax:<br>
 * ---------------------<br>
 * <br>
 ...
 * protected void updateAjaxAttributes(final AjaxRequestAttributes attributes) {<br>
    ...
    public ReCaptchaV2Panel(String id) {
        ...
        add(new NonceInlineScript("recaptcha_js") {
            ...
            protected void onComponentTag(ComponentTag tag) {
                ...
                tag.getAttributes().put("src", ReCaptchaV2.API + ReCaptchaV2.LANG + WebSession.get().getLocale().getLanguage().toLowerCase());
            }
        });
        add(new WebMarkupContainer("recaptchatag") {
            ...
            protected void onComponentTag(ComponentTag tag) {
                super.onComponentTag(tag);
                tag.getAttributes().put("data-sitekey", reCaptchaV2.getVisible() ? reCaptchaV2.getVisible_sitekey() : reCaptchaV2.getInvisible_sitekey());
