...
public class FormPanel<T extends Serializable> extends FormPanelParent<T> {
    ...
    public PasswordFieldPanel<String> addPasswordField(String propertyPath, TextFieldSettings componentSettings) {
        return this.addDefaultRow(new PasswordFieldPanel<>(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings));
    }
    ...
    public <F extends Serializable> RadioButtonsAltPanel<F> addRadioButtonsAlt(F propertyPath, FormElementSettings componentSettings, IModel<? extends List<? extends F>> choices, IChoiceRenderer<F> renderer) {
        return this.addDefaultRow(new RadioButtonsAltPanel<>(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, choices, renderer));
    }

    public <F extends Serializable> DropDownPanel<F> addDropDown(F propertyPath, DropDownSettings componentSettings, IOptionRenderer<F> renderer, IModel<? extends List<? extends F>> choices) {
    ...
    public <F extends Serializable> DropDownPanel<F> addDropDown(F propertyPath, DropDownSettings componentSettings, IOptionRenderer<F> renderer, IModel<? extends List<? extends F>>[] choices, IModel<String>[] groupLabels) {
    ...
    public <F extends Serializable> ListPanel<F> addList(F propertyPath, ListSettings componentSettings, IOptionRenderer<F> renderer, IModel<? extends List<? extends F>> choices) {
    ...
    public <F extends Serializable> ListPanel<F> addList(F propertyPath, ListSettings componentSettings, IOptionRenderer<F> renderer, IModel<? extends List<? extends F>>[] choices, IModel<String>[] groupLabels) {
    ...
    public <I extends Serializable> MultiSelectPanel<I> addMultiSelect(//
        ...
        return this.addDefaultRow(new MultiSelectPanel<>(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, renderer, choices));
    }
    ...
    public <I extends Serializable> MultiSelectPanel<I> addMultiSelect(//
        ...
        return this.addDefaultRow(new MultiSelectPanel<>(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, renderer, choices, groupLabels));
    }
    ...
    public RatingFieldPanelAlt addRatingFieldAlt(Integer propertyPath, RatingFieldSettings componentSettings) {
        return this.addDefaultRow(new RatingFieldPanelAlt(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings));
    }
    ...
    public <F extends Serializable> DatePickerPanel<F> addDatePicker(F propertyPath, DatePickerSettings componentSettings, Converter<F, Date> dateConverter) {
    ...
    public TypeAheadTextFieldPanel addTypeAheadTextField(String propertyPath, TypeAheadTextFieldSettings componentSettings, IModel<? extends List<String>> choices) {
        return this.addDefaultRow(new TypeAheadTextFieldPanel(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, choices));
    }

    public TypeAheadTextFieldAltPanel addTypeAheadTextFieldAlt(String propertyPath, TypeAheadTextFieldAltSettings componentSettings, IModel<? extends List<Map<String, String>>> choices) {
        return this.addDefaultRow(new TypeAheadTextFieldAltPanel(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, choices));
    }

    public static final CssResourceReference FLAGS_CSS = new CssResourceReference(FormPanel.class, "country/flags/css/flag-icon.css");
    ...
    public static final JavaScriptResourceReference COUNTRY_EXTRA_JS = new JavaScriptResourceReference(FormPanel.class, "country/countries-extra.js");

    public TypeAheadTextFieldAltPanel addCountryTypeAhead(String propertyPath, TypeAheadTextFieldAltSettings componentSettings) {
        if (componentSettings.getProperties() == null || (componentSettings.getProperties().size() == 1 && "value".equals(componentSettings.getProperties().get(0)))) {
            componentSettings.setProperties(Arrays.asList("name", "adjectivals", "iso"));
        }
        if ("value".equals(componentSettings.getTemplate())) {
            componentSettings.setTemplate("\"<span class='flag-icon flag-icon-\"+ item.iso.toLowerCase()+ \" flag-icon'></span>&nbsp;{{name}}:&nbsp;{{capital}}&nbsp;{{adjectivals}}&nbsp;[{{iso}}]&nbsp;(+{{phone}})\"");
        }
        if (componentSettings.getLocal() == null) {
            componentSettings.setLocal("countrydata");
        }
        return this.addDefaultRow(new TypeAheadTextFieldAltPanel(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, null) {
            @Override
    ...
    public <I extends Serializable> BootstrapSelectPanel<I> addBootstrapSelect(//
        ...
        return this.addDefaultRow(new BootstrapSelectPanel<>(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, renderer, contentRenderer, choices));
    }
    ...
    public <I extends Serializable> BootstrapSelectPanel<I> addBootstrapSelect(//
        ...
        return this.addDefaultRow(new BootstrapSelectPanel<>(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, renderer, contentRenderer, choices, groupLabels));
    }
    ...
    public <I extends Serializable> BootstrapMultiSelectPanel<I> addBootstrapMultiSelect(//
        ...
        return this.addDefaultRow(new BootstrapMultiSelectPanel<>(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, renderer, contentRenderer, choices));
    }
    ...
    public <I extends Serializable> BootstrapMultiSelectPanel<I> addBootstrapMultiSelect(//
        ...
        return this.addDefaultRow(new BootstrapMultiSelectPanel<>(this.getFormModel(), propertyPath, this.getFormSettings(), componentSettings, renderer, contentRenderer, choices, groupLabels));
    }
}
