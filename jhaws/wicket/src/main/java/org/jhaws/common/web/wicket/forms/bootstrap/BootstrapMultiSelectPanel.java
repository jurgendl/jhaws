...
public class BootstrapMultiSelectPanel<T extends Serializable> extends DefaultFormRowPanel<List<T>, Select<List<T>>, BootstrapMultiSelectSettings> {
    ...
    public BootstrapMultiSelectPanel(IModel<?> model, LambdaPath<?, List<T>> propertyPath, FormSettings formSettings, BootstrapMultiSelectSettings componentSettings, IOptionRenderer<T> renderer, IOptionRenderer<T> contentRenderer,
