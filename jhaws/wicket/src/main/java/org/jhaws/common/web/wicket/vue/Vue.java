package org.jhaws.common.web.wicket.vue;
...
//v2.6.14 - https://cdn.jsdelivr.net/npm/vue@2/dist/vue.js (dev) - https://cdn.jsdelivr.net/npm/vue@2 (prd=min)
//
//v3.2.33 - https://unpkg.com/vue@3.2.33/dist/vue.global.js
public class Vue {
	public static JavaScriptResourceReference JSV2 = new JavaScriptResourceReference(Vue.class, "vue.js");
	public static JavaScriptResourceReference JSV3 = new JavaScriptResourceReference(Vue.class, "v3/vue.global.js");

	/**
	 * Wicket renderHead:<br>
	 * response.render(JavaScriptHeaderItem.forReference(Vue.JS_APP));<br>
	 * response.render(JavaScriptHeaderItem.forScript(";var testVueApplication =
	 * AppVue('" + RestCte.getRestPath() + VueTestRest.PATH + "','appVueTest');",
	...
	static {
		JS_APP.addJavaScriptResourceReferenceDependency(JSV2);
