...
import static org.jhaws.common.web.wicket.WebHelper.name;
...
import org.jhaws.common.web.wicket.tables.bootstrap.Table.ActionsPanel;
import org.jhaws.common.web.wicket.tables.bootstrap.Table.BooleanColumn;
import org.jhaws.common.web.wicket.tables.bootstrap.Table.EmailColumn;
import org.jhaws.common.web.wicket.tables.bootstrap.Table.URIColumn;
import org.jhaws.common.web.wicket.tables.bootstrap.Table.URLColumn;
import org.jhaws.common.web.wicket.tables.bootstrap.Table.URLStringColumn;
...
//    }
			...
			label = new AbstractReadOnlyModel<String>() {
				...
				public String getObject() {
					try {
						...
						logger.error(parent.getClass().getName() + ": no translation for " + "[" + property + "_"
								+ parent.getLocale() + "]");
	...
	public static <T extends Serializable> TableColumn<T, Object> getActionsColumn(Component parent,
	...
	public static class ActionsColumn<T extends Serializable> extends TableColumn<T, Object> {
		...
		public String getCssClass() {
			return super.getCssClass() + " actions"; // -> set fixed width on
