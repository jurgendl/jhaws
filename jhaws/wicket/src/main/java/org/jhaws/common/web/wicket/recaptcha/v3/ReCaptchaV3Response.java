...
public class ReCaptchaV3Response {
    ...
    public String toString() {
        return "ReCaptchaV3Response [" + (this.challengeTimestamp != null ? "challengeTimestamp=" + this.challengeTimestamp + ", " : "") + (this.hostname != null ? "hostname=" + this.hostname + ", " : "") + "success=" + this.success + ", "
                + (this.action != null ? "action=" + this.action + ", " : "") + (this.score != null ? "score=" + this.score + ", " : "") + (this.errorCodes != null ? "errorCodes=" + Arrays.toString(this.errorCodes) : "") + "]";
    }
