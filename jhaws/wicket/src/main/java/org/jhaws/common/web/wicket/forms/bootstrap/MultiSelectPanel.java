...
public class MultiSelectPanel<T extends Serializable>
		extends DefaultFormRowPanel<List<T>, Select<List<T>>, MultiSelectSettings> {
	...
	public MultiSelectPanel(IModel<?> model, List<T> propertyPath, FormSettings formSettings,
			MultiSelectSettings componentSettings, IOptionRenderer<T> renderer,
