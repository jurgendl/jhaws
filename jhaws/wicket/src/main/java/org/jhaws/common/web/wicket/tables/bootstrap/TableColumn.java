...
public class TableColumn<T, D> implements IStyledColumn<T, String>, IExportableColumn<T, String, D> {
    public static final String CSS_SERVER_SORTABLE = "serversortable";

    public static final String CSS_CLIENT_SORTABLE = "clientsortable";

    public static final String CSS_UNSORTABLE = "unsortable";
    ...
    public String getCssClass() {
        if (this.sorting == Side.client) {
            return TableColumn.CSS_CLIENT_SORTABLE;
        }
        if (this.sorting == Side.server) {
            return TableColumn.CSS_SERVER_SORTABLE;
        }
        return TableColumn.CSS_UNSORTABLE;
    }
    ...
    public IModel<D> getDataModel(IModel<T> rowModel) {
        PropertyModel<D> propertyModel = new PropertyModel<>(rowModel, this.propertyExpression);
