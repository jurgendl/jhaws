...
public class BootstrapDatePicker {
    ...
    public static JavaScriptResourceReference JS_I18N = new JavaScriptResourceReference(BootstrapDatePicker.class, RESOURCE_I18N_PATH + "bootstrap-datepicker.js").addJavaScriptResourceReferenceDependency(JS);
