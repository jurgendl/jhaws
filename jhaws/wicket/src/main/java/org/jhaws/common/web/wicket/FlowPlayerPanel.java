...
public class FlowPlayerPanel extends Panel {
    ...
    protected WebMarkupContainer createPlayer(FlowPlayerConfig _config) {
        ...
        Html5VideoElement html5VideoElement = _config.getSources().get(0);
        videosource.add(new AttributeModifier("type", html5VideoElement.getMimetype()));
        videocontainer.add(new AttributeModifier("preload", "none")); // metadata
        videosource.add(new AttributeModifier("src", html5VideoElement.getUrl()));
