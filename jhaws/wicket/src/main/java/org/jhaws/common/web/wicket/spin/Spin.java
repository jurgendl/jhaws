...
//
// <span wicket:id="spinnercontainer" data-id="spinnercontainer" class="invisible">
...
// }
public class Spin {
	public static final String HIDE = ";$('[data-id=\"spinnercontainer\"]').removeClass('visible').addClass('invisible');";

	public static final String SHOW = ";$('[data-id=\"spinnercontainer\"]').removeClass('invisible').addClass('visible');";
	...
	public static CssResourceReference SPINKIT_FADING_CIRCLE = new CssResourceReference(Spin.class,
			"sk-fading-circle.css");
	public static CssResourceReference SPINKIT_FOLDING_CUBE = new CssResourceReference(Spin.class,
			"sk-folding-cube.css");
