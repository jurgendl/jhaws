package org.jhaws.common.web.wicket.blazy;
...
public class BLazyImage extends Image {
	...
	public BLazyImage(String id, ImageDataProvider imageDataProvider) {
		super(id);
		...
		setImageResourceReference(new ResourceReference(BLazyImage.class, imageDataProvider.getName()) {
			@Override
	...
	protected void onComponentTag(ComponentTag tag) {
		...
		adjustTag(tag);
		if (width != null)
			tag.getAttributes().put("width", width);
		if (height != null)
			tag.getAttributes().put("height", height);
	}
