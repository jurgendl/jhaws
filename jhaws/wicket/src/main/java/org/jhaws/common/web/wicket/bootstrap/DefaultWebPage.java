...
public abstract class DefaultWebPage extends WebPage {
    ...
    protected static final JavaScriptResourceReference JS = new JavaScriptResourceReference(WicketRoot.class, "bootstrap/base.js");
    ...
    protected void addOpenGraph(PageParameters parameters, MarkupContainer html, boolean show) {
        ...
        // og:determiner - The word that appears before this object's title in a sentence. An enum of (a, an, the, "", auto). If auto is chosen, the consumer of your data should
