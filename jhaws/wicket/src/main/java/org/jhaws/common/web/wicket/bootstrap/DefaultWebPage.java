...
public abstract class DefaultWebPage extends WebPage {
	...
	public static final JavaScriptResourceReference JS = new JavaScriptResourceReference(WicketRoot.class,
			"bootstrap/base.js");
	...
	protected void demos(List<NavBarLink> navs) {
		...
		demos.getChildLinks()
				.add(new NavBarLink("public", "", org.jhaws.common.web.wicket.pages.PublicPage.class, null));
		demos.getChildLinks()
				.add(new NavBarLink("register", "", org.jhaws.common.web.wicket.pages.RegisterPage.class, null));
		navs.add(demos);
	}
