...
public class TableColumn<T, D> implements IStyledColumn<T, String>, IExportableColumn<T, String, D> {
	...
	/**
	 * Factory method for generating a model that will generated the displayed value. Typically the model is a property model using the {@link #propertyExpression} specified in the
	 * constructor.
	 */
	@Override
