...
public class JQueryValidation {
	...
	public static JavaScriptResourceReference VALIDATION_ADDITIONAL_JS = new JavaScriptResourceReference(JQueryValidation.class, PATH_ADDITIONAL_METHODS_JS)
			.addJavaScriptResourceReferenceDependency(VALIDATION_JS);

	public static JavaScriptResourceReference VALIDATION_LOCALIZATION_JS = new JavaScriptResourceReference(JQueryValidation.class, PATH_LOCALIZATION_MESSAGES_JS)
			.addJavaScriptResourceReferenceDependency(VALIDATION_JS);

	public static JavaScriptResourceReference VALIDATION_LOCALIZATION_METHODS_JS = new JavaScriptResourceReference(JQueryValidation.class, PATH_LOCALIZATION_METHODS_JS)
			.addJavaScriptResourceReferenceDependency(VALIDATION_LOCALIZATION_JS);
	...
	public static UrlResourceReference CDN_VALIDATION_LOCALIZATION_METHODS_JS = new UrlResourceReference(Url.parse(URL + PATH_LOCALIZATION_METHODS_JS)) {
