...
public class JQueryUIColorPicker {
	...
	public static JavaScriptResourceReference JQUERY_COLORPICKER_JS = new JavaScriptResourceReference(JQueryUIColorPicker.class, "jquery.colorpicker.js");
	...
	public static JavaScriptResourceReference JQUERY_COLORPICKER_FACTORY_JS = new JavaScriptResourceReference(JQueryUIColorPicker.class, "jquery.colorpicker.factory.js")
			.addJavaScriptResourceReferenceDependency(JQUERY_COLORPICKER_JS);
