...
public class LocaleDropDownPanel extends FormRowPanel<Locale, Locale, LocalesDropDown, FormElementSettings> {
	...
	public LocaleDropDownPanel(Locale propertyPath, IModel<Locale> valueModel, FormSettings formSettings, FormElementSettings componentSettings, IModel<List<Locale>> choices,
	...
	public LocaleDropDownPanel(IModel<?> model, Locale propertyPath, FormSettings formSettings, FormElementSettings componentSettings, IModel<List<Locale>> choices,
			IChoiceRenderer<Locale> renderer) {
