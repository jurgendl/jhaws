package org.tools.hqlbuilder.webservice.jquery.ui.weloveicons;
...
public class WeLoveIcons {
	...
	public static CssResourceReference SOCIAL_COLORS_HOVER_CSS = new CssResourceReference(WeLoveIcons.class, "socialcolorshover.css");

	public static void main(String[] args) {
		try (InputStream in = new FileInputStream("We Love Icon Fonts.htm"); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
			...
			String[] type = { "brandico", "entypo", "fontawesome", "fontelico", "iconicfill", "iconicstroke", "maki", "openwebicons", "typicons", "zocial" };
			for (String t : type) {
