...
public class FormPanel<T extends Serializable> extends FormPanelParent<T> {
    ...
    protected RepeatingView getComponentRepeater() {
        ...
        if (this.componentRepeater == null) {
            ...
            rowContainer.add(new CssClassNameAppender("cols" + this.getFormSettings().getColumns() + " " + this.renderColumnsCss(
                    this.getFormSettings().isShowLabel(), this.getFormSettings().getColumns(), this.getFormSettings().getLabelWidth())));
            ...
            if (this.getFormSettings().isStateless()) {
                this.form = new StatelessForm<T>(FormConstants.FORM, formModel) {
                    ...
                    protected String getMethod() {
                        return FormPanel.this.formSettings.getMethod() != null ? FormPanel.this.formSettings.getMethod().toString()
                                : super.getMethod();
                    }
