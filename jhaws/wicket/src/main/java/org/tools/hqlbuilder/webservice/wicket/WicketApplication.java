...
public class WicketApplication extends WebApplication {
	...
	protected void addBundles() {
		this.getResourceBundles().addJavaScriptBundle(WicketJSRoot.class, "tinymcebundle.js",
				new JavaScriptResourceReference[] { BootstrapTinyMCE.JS, BootstrapTinyMCE.JS_JQUERY,
						BootstrapTinyMCE.JS_PLUGIN_ADVLIST, BootstrapTinyMCE.JS_PLUGIN_ANCHOR,
						BootstrapTinyMCE.JS_PLUGIN_AUTOLINK, BootstrapTinyMCE.JS_PLUGIN_CHARMAP,
						BootstrapTinyMCE.JS_PLUGIN_CODE, BootstrapTinyMCE.JS_PLUGIN_COLORPICKER,
						BootstrapTinyMCE.JS_PLUGIN_HELP, BootstrapTinyMCE.JS_PLUGIN_HR,
						BootstrapTinyMCE.JS_PLUGIN_IMAGE, BootstrapTinyMCE.JS_PLUGIN_INSERTDATETIME,
						BootstrapTinyMCE.JS_PLUGIN_LINK, BootstrapTinyMCE.JS_PLUGIN_LISTS,
						BootstrapTinyMCE.JS_PLUGIN_MEDIA, BootstrapTinyMCE.JS_PLUGIN_PASTE,
						BootstrapTinyMCE.JS_PLUGIN_PREVIEW, BootstrapTinyMCE.JS_PLUGIN_PRINT,
						BootstrapTinyMCE.JS_PLUGIN_SEARCHREPLACE, BootstrapTinyMCE.JS_PLUGIN_TABLE,
						BootstrapTinyMCE.JS_PLUGIN_TEXTCOLOR, BootstrapTinyMCE.JS_PLUGIN_VISUALCHARS,
