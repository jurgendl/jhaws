...
public class FlowPlayer {
	...
	public static CssResourceReference SKIN_CSS_MINI = new CssResourceReference(FlowPlayer.class,
			"skin/minimalist.css");
	...
	public static String url() {
		if (url == null) {
			url = WicketUtils.mountStream(FlowPlayer.swf,
					new StreamResourceReference(FlowPlayer.class, FlowPlayer.swf) {
						...
						public IResourceStream getResourceStream() {
							return new AbstractResourceStream() {
								...
								public InputStream getInputStream() throws ResourceStreamNotFoundException {
									if (inputStream == null) {
										try {
											inputStream = FlowPlayer.class.getClassLoader().getResourceAsStream(
													FlowPlayer.class.getPackage().getName().replace('.', '/') + "/"
															+ swf);
										} catch (Exception e) {
