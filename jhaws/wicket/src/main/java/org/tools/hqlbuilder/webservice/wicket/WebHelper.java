...
public class WebHelper {
	...
	/**
	 * welke generic type implementatie heeft een class implementatie (werkt ook op
	 * anonymous inner classes)
	 *
	 * @param object
	 *            de implementatie class (this waar opgeroepen)
	 * @param classOrInterfaceWithGenericType
	 *            class of interface waardat de generic type naam op gedeclareerd
	 *            staat
	 * @param genericTypeIndex
	 *            de index binnen de &lt; en &gt; waar de generic type naam op
	 *            gedeclareerd staat; als er maar 1 is wordt die zowiezo genomen
	 *            (maw index 0)
	 * @param requiredGenericType
	 *            vereiste class (alternatief voor index)
	 *
	 * @return de effectieve implementatie
	 *
	 * @throws IllegalArgumentException
	 *             wanneer index niet gevonden wordt of geen implementatie van class
	 *             c
	 */
	@SuppressWarnings("unchecked")
	private static <P, G extends P> Class<G> _getImplementation(Object object, Class<?> classOrInterfaceWithGenericType,
			int genericTypeIndex, Class<P> requiredGenericType) throws IllegalArgumentException {
		...
		while (parameterizedType == null && clazz != null) {
			for (Type type : clazz.getGenericInterfaces()) {
				if (type instanceof ParameterizedType
						&& ParameterizedType.class.cast(type).getRawType().equals(classOrInterfaceWithGenericType)) {
	 ...
	 */
	public static <G> Class<G> getImplementation(Object object, Class<?> classOrInterfaceWithGenericType)
			throws IllegalArgumentException {
	 ...
	 */
	public static <G> Class<G> getImplementation(Object object, Class<?> classOrInterfaceWithGenericType,
			int genericTypeIndex) throws IllegalArgumentException {
	 ...
	 * @see #getImplementation(Object, Class, int)
	 */
	public static <P, G extends P> Class<G> getImplementation(Object object, Class<?> classOrInterfaceWithGenericType,
