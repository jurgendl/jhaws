...
public class WebHelper {
	 ...
	 *            class of interface waardat de generic type naam op gedeclareerd staat
	 * @param genericTypeIndex
	 *            de index binnen de &lt; en &gt; waar de generic type naam op gedeclareerd staat; als er maar 1 is wordt die zowiezo genomen (maw index 0)
	 ...
	 *             wanneer index niet gevonden wordt of geen implementatie van class c
	 */
	@SuppressWarnings("unchecked")
	private static <P, G extends P> Class<G> _getImplementation(Object object, Class<?> classOrInterfaceWithGenericType, int genericTypeIndex, Class<P> requiredGenericType)
			throws IllegalArgumentException {
