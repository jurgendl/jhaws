...
public class TableSorter {
	...
	public static JavaScriptResourceReference TABLE_SORTER_WIDGETS_JS = new JavaScriptResourceReference(TableSorter.class, "js/jquery.tablesorter.widgets.js")
			.addJavaScriptResourceReferenceDependency(TABLE_SORTER_JS);
}
