 ...
 */
public class TriStateCheckBoxPanel
		extends DefaultFormRowPanel<Boolean, HiddenField<Boolean>, TriStateCheckBoxSettings> {
	...
	public TriStateCheckBoxPanel(IModel<?> model, Boolean propertyPath, FormSettings formSettings,
	...
	protected HiddenField<Boolean> createComponent(IModel<Boolean> model, Class<Boolean> valueType) {
		HiddenField<Boolean> hiddenField = new HiddenField<>(VALUE, model);
