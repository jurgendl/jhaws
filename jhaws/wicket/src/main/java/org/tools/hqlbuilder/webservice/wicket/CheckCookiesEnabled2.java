...
public class CheckCookiesEnabled2 extends Panel {
    private static final long serialVersionUID = -5913144741901927426L;

    public static JavaScriptResourceReference JS = new JavaScriptResourceReference(CheckCookiesEnabled.class, "CheckCookiesEnabled2.js");

    public CheckCookiesEnabled2() {
        ...
        cookiesQ.add(new StatelessLink<String>("allowCookies") {
            ...
            public void onClick() {
                ...
                CheckCookiesEnabled2.this.get("nocookies").setVisible(false);
            }
        });
