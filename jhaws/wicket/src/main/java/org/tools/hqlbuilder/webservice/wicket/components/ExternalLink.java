...
public class ExternalLink extends org.apache.wicket.markup.html.link.ExternalLink {
	...
	public ExternalLink setOpenInNewPage(boolean b) {
		add(new AttributeModifier("target", b ? new Model<>("_blank") : null));
		return this;
	}
	...
	protected boolean isLinkEnabled() {
		if (whenNull == WhenNull.DISABLE) {
			return super.isLinkEnabled() && getDefaultModel() != null && getDefaultModelObject() != null && StringUtils.isNotBlank(getDefaultModelObjectAsString());
		}
	...
	public boolean isVisible() {
		if (whenNull == WhenNull.HIDE) {
			return super.isVisible() && getDefaultModel() != null && getDefaultModelObject() != null && StringUtils.isNotBlank(getDefaultModelObjectAsString());
		}
