...
public class Spectrum {
	...
	public static JavaScriptResourceReference SPECTRUM_I18N_JS = new JavaScriptResourceReference(Spectrum.class, RESOURCE_I18N_PATH + "jquery.spectrum.js")
			.addJavaScriptResourceReferenceDependency(SPECTRUM_JS);
