...
public abstract class DefaultWebPage extends WebPage {
	...
	protected static final JavaScriptResourceReference JS = new JavaScriptResourceReference(DefaultWebPage.class,
			"DefaultWebPage.js");

	protected static final CssResourceReference CSS = new CssResourceReference(DefaultWebPage.class,
			"DefaultWebPage.css");
