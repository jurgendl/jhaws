...
public abstract class DefaultWebPage extends WebPage {
    protected static final String FACTORY = new FilePath(WicketRoot.class, "wicket/bootstrap/base-factory.js").readAll();

    protected static final JavaScriptResourceReference JS = new JavaScriptResourceReference(WicketRoot.class, "wicket/bootstrap/base.js");

    protected static final CssResourceReference CSS = new CssResourceReference(WicketRoot.class, "wicket/bootstrap/base.css");
    ...
    protected void renderCodeStyling(IHeaderResponse response) {
        ...
        response.render(CssHeaderItem.forReference(new CssResourceReference(PrismJs.class, "themes/prism-okaidia.css")));
