    ...
    protected Behavior setupDynamicRequiredBehavior() {
        return new AjaxFormComponentUpdatingBehavior(HtmlFormEvent.BLUR) {
            ...
            protected void onError(AjaxRequestTarget ajaxRequestTarget, RuntimeException e) {
                ...
                c.add(new CssClassNameRemover(FormRowPanel.this.formSettings.getValidClass()));
                c.add(new CssClassNameAppender(FormRowPanel.this.formSettings.getInvalidClass()));
            ...
            protected void onUpdate(AjaxRequestTarget ajaxRequestTarget) {
                C c = FormRowPanel.this.getComponent();
                c.add(new CssClassNameRemover(FormRowPanel.this.formSettings.getInvalidClass()));
                c.add(new CssClassNameAppender(FormRowPanel.this.formSettings.getValidClass()));
                ajaxRequestTarget.add(c, FormRowPanel.this.getFeedback());
            }
        };
    }
