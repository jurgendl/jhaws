...
public class JCIFSEngine implements NTLMEngine {
	...
	@Override
	public String generateType3Msg(String username, char[] password, String domain, String workstation,
		...
		final Type3Message type3Message = new Type3Message(type2Message, new String(password), domain, username,
