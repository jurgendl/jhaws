...
public class User implements Serializable, Comparable<User> {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().appendSuper(super.equals(object)).append(this.cn, rhs.cn).append(this.description, rhs.description)
				.append(this.telephoneNumber, rhs.telephoneNumber).append(this.surname, rhs.surname).append(this.objectClass, rhs.objectClass).append(this.reference, rhs.reference)
				.isEquals();
	}
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder(-1529639275, 107903843).appendSuper(super.hashCode()).append(this.cn).append(this.description).append(this.telephoneNumber).append(this.surname)
				.append(this.objectClass).append(this.reference).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("description", this.description).append("surname", this.surname).append("telephoneNumber", this.telephoneNumber) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				.append("reference", this.reference).append("cn", this.cn).append("objectClass", this.objectClass).toString(); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
}
