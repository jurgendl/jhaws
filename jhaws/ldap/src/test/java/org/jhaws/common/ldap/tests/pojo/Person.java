...
public class Person implements Serializable, Comparable<Person> {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("c", this.c) //$NON-NLS-1$
                .append("uid", this.uid) //$NON-NLS-1$
                .append("sn", this.sn) //$NON-NLS-1$
                .append("serialNumber", this.serialNumber) //$NON-NLS-1$
