...
public class ImageIndexerTest {
    ...
    public void test() {
        ...
        FilePath last = null;
        for (int i = 0; i < 10; i++) {
            last = new FilePath(ImageIndexerTest.class.getClassLoader(), i + ".jpg").writeTo(tmp.child(i + ".jpg"));
        }
        double max = 15.0;
        ImageSimilarities results;
        System.out.println("==================================================");
        System.out.println("-------------- RUN 1 =============================");
        List<Class<? extends GlobalFeature>> methods = Arrays.asList(CEDD.class, FCTH.class, EdgeHistogram.class, ColorLayout.class,
                ScalableColor.class, Tamura.class, Gabor.class);
        results = new ImageIndexer().findDuplicatesExt(tmp.child("dubsindex"), tmp, tmp.child("dubsreport1.xml"), max, methods);
        System.out.println("==================================================");
        System.out.println("==================================================");
        ...
        results = new ImageIndexer().findDuplicatesExt(tmp.child("dubsindex"), tmp, tmp.child("dubsreport2.xml"), max, methods);
        System.out.println("==================================================");
        System.out.println("==================================================");
    }
}
