...
public class DocExtractTest {
    ...
    private void test(String docName) {
        try {
            ...
            System.out.println(FilePath.getHumanReadableFileSize((long) TikaHelper.parse(path.newInputStream()).length()));
            System.out.println(FilePath.getHumanReadableFileSize((long) TikaHelper.parseToString(path.newInputStream()).length()));
            // System.out.println("---------------------------------------------");
    ...
    private void testPdfOptions(InputStream in) {
        ...
        fileTextExtracters.forEach(i -> {
            ...
            System.out.println(i.getClass() + " // " + target.getFileSize() + " // " + (System.currentTimeMillis() - start) + "ms");
        });
        System.out.println("============================================");
    }
}
