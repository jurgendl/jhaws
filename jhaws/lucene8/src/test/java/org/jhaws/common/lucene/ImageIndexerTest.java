...
public class ImageIndexerTest {
    ...
    public void test() {
        ...
        double max = 15.0;
        List<Class<? extends GlobalFeature>> methods = Arrays.asList(CEDD.class, FCTH.class, EdgeHistogram.class, ColorLayout.class, ScalableColor.class, /* Tamura.class, */ Gabor.class);
        ImageSimilarities results;
        System.out.println("==================================================");
        System.out.println("-------------- RUN 1 =============================");
        results = new ImageIndexer().findDuplicatesExt(tmp.child("dubsindex"), Arrays.asList(tmp), tmp.child("dubsreport1.xml"), max, methods);
        System.out.println("==================================================");
        System.out.println("==================================================");
        results.forEach(System.out::print);
        System.out.println("==================================================");
        System.out.println("-------------- RUN 2 =============================");
        results = new ImageIndexer().findDuplicatesExt(tmp.child("dubsindex"), Arrays.asList(tmp), tmp.child("dubsreport2.xml"), max, methods);
        System.out.println("==================================================");
        System.out.println("==================================================");
        results.forEach(System.out::print);
        System.out.println("==================================================");
