...
public class ComboBoxDemo {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 1000; i++) {
			record = new EComboBoxRecord<>(String.valueOf(r.nextInt(1000000000)) + String.valueOf(r.nextInt(1000000000)) + String.valueOf(r.nextInt(1000000000))
					+ String.valueOf(r.nextInt(1000000000)) + String.valueOf(r.nextInt(1000000000)));
			cc.addRecord(record);
		}
