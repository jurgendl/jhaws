...
public class WrapperTest {
	@Test
	public void test1() {
		EComboBox<String> comp = new EComboBox<>(new EComboBoxConfig());
	...
	@Test
	public void test2() {
		new ECheckBoxTree<>(new ECheckBoxTreeNode<String>(null)).stsi().setVisible(true);
		...
		new ETree<>(new ETreeNode<String>(null)).stsi().setVisible(true);
		new ETreeTable<>(new ETreeTableConfig(), new ETreeTableHeaders<String>("test")).stsi().setVisible(true);
	}
}
