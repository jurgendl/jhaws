...
public class FormattedFieldDemo {
	private static void addComponents(Container container) throws ParseException, MalformedURLException {
		...
		container.add(
				new EFormattedTextField<>(new EFormattedTextFieldConfig(new DateFormatBuilder(DateFormatBuilder.Type.Date, DateFormatBuilder.Length.Default)), new Date()));
		container.add(new ELabel("time"));
		container.add(
				new EFormattedTextField<>(new EFormattedTextFieldConfig(new DateFormatBuilder(DateFormatBuilder.Type.Time, DateFormatBuilder.Length.Default)), new Date()));
		container.add(new ELabel("date/time"));
		container.add(
				new EFormattedTextField<>(new EFormattedTextFieldConfig(new DateFormatBuilder(DateFormatBuilder.Type.Both, DateFormatBuilder.Length.Default)), new Date()));
