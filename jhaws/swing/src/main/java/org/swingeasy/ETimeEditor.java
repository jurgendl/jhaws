...
public class ETimeEditor extends EDateEditor {
    ...
    public SimpleDateFormat getFormatter() {
        if (formatter == null) {
            formatter = SimpleDateFormat.class.cast(DateFormat.getTimeInstance(DateFormat.SHORT, Locale.getDefault()));
        }
        return formatter;
    }
    ...
    public void setLocale(Locale l) {
        super.setLocale(l);
        getLabel().setText(Messages.getString(l, "ETimeEditor.label.text") + ": ");
    }
}
