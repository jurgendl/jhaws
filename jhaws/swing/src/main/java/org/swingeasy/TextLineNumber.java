...
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
    private static final long serialVersionUID = -821808937796254742L;
    ...
    private void documentChanged() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    int endPos = TextLineNumber.this.component.getDocument().getLength();
                    Rectangle rect = TextLineNumber.this.component.modelToView(endPos);
