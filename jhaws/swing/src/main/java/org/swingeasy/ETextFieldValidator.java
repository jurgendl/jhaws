...
public class ETextFieldValidator extends DocumentFilter {
    ...
    public ETextFieldValidator filterInput(Function<String, String> filterInput) {
        this.filterInput = filterInput;
        return this;
    }

    public ETextFieldValidator validateText(Predicate<String> textValidator) {
    ...
    public void insertString(FilterBypass fb, int offset, String string, AttributeSet attr) throws BadLocationException {
        ...
        if (textValidator != null) {
            if (!textValidator
                    .test(new StringBuilder(fb.getDocument().getText(0, fb.getDocument().getLength())).insert(offset, replaced).toString())) {
                return;
            }
        }
    ...
    public void replace(FilterBypass fb, int offset, int length, String string, AttributeSet attrs) throws BadLocationException {
        String replaced = filterInput == null ? string : filterInput.apply(string);
        if (textValidator != null) {
            if (!textValidator.test(new StringBuilder(fb.getDocument().getText(0, fb.getDocument().getLength())).delete(offset, offset + length)
                    .insert(offset, replaced)
                    .toString())) {
                return;
            }
        }
    ...
    public void remove(FilterBypass fb, int offset, int length) throws BadLocationException {
        if (textValidator != null) {
            if (!textValidator
                    .test(new StringBuilder(fb.getDocument().getText(0, fb.getDocument().getLength())).delete(offset, offset + length).toString())) {
                return;
            }
        }
