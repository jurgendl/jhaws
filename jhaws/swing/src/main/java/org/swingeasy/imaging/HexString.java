...
public class HexString {
	 ...
	 *
	 * @param b
	 *            : byte: a byte whose hex representation is to be obtained
	 * @param hexString
	 *            : String : the string to append the hex digits to
	 */
	 ...
	 *
	 * @param buffer
	 *            : byte[] : a buffer to convert to hex
	 *
	 * @return : String : the hex string version of the input buffer
	 */
	 ...
	 *            : byte[] : a buffer to convert to hex
	 * @param startOffset
	 *            : int : the offset of the first byte in the buffer to process
	 * @param length
	 *            : int : the number of bytes in the buffer to process
	 *
	 * @return : String : the hex string version of the input buffer
	 */
	 ...
	 * the byte value that they represent, and that byte value is appended to a byte array which is ultimately returned. function doesn't care whether the hexadecimal characters
	 * are upper or lower case, and it also can handle odd-length hex strings by assuming a leading zero digit. If any character in the input string is not a valid hexadecimal
	 * digit, it throws a NumberFormatException, in keeping with the behavior of Java functions like Integer.parseInt().
	 *
	 * @param hexString
	 *            : String : a string of hexadecimal characters
	 *
	 ...
	 *
	 * @param s
	 *            : String : hexadecimal string (2 characters)
	 *
	 * @return : byte
	 *
	...
	/**
	 * prints the hex String to a easier to read text to the console with default 8 hex characters per block and 4 blocks on a line, default separator is ' '
	 *
	 * @param hexedString
	 *            : String : hex string
	 *
	 ...
	 * @param hexedString
	 *            : String : hex string
	 * @param hexPairsOnBlock
	 *            : int : number of characters pairs in a block without block separator ' ' (will always be even)
	 * @param hexBlocksOnLine
	 *            : int : number of blocks on a line without block separator '\n'
	 * @param separator
	 *            : String : separator string/character
	 * @param suffix
	 *            : String : suffix before each line
	 *
	 * @return : String : formatted hex string
	 */
	public static String printHexString(final String hexedString, int hexPairsOnBlock, final int hexBlocksOnLine, final String separator, final String suffix) {
	 ...
	 *
	 * @param source
	 *            : String : source hex string with spaces
	 *
	 ...
	 *
	 * @param separatorChar2
	 *            : char : separator character (normally a space ' ')
	 */
	...
	/**
	 * Returns a string containing the hexadecimal repr esentation of the input string. Each byte in the input string is converted to a two-digit hexadecimal value. Thus the
	 ...
	 *
	 * @param string
	 *            : String : a string to convert to hex
	 *
