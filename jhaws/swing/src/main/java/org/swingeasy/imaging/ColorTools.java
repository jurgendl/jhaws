...
public class ColorTools {
	 ...
	 * @param baseColor
	 *            : Color : base color
	 * @param halfnumberdifs
	 *            : int : half the number of changes
	 *
	 ...
	 *
	 * @param rgb
	 *            : int : rgb value (when rgba, alpha will be dropped first)
	 * @param alpha
	 *            : int : alpha (0=transparent - 255=opaque)
	 *
	 * @return : int : color int rgba value
	 ...
	 *            : Colors : base color
	 * @param halfnumberdifs
	 *            : int : will search for #halfnumberdifs colors clockwise and #halfnumberdifs colors counter-clockwise
	 * @param degrees
	 *            : int : number of degrees (counter-)colockwise to turn
	 *
	 ...
	 *
	 * @param hex
	 *            : String : hex string either with or without the # sign
	 *
	 * @return : Color : color
	 */
