...
public class ETreeNode<T> extends DefaultMutableTreeNode {
	...
	/**
	 * treenode with easger init of children, give an empty collection to make a
	 * childless eager treenode
	 */
	...
	/**
	 * called when children is not initialized an {@link #getAllowsChildren()} is
	 * true (default)
	 * 
	 * @param list
	 */
