...
public class DnDTabbedPane extends JTabbedPane {
    ...
    public void autoScrollTest(Point pt) {
        ...
        if (tabPlacement == SwingConstants.TOP || tabPlacement == SwingConstants.BOTTOM) {
            ...
            DnDTabbedPane.rForward.setBounds(r.x + r.width - DnDTabbedPane.rwh - DnDTabbedPane.buttonsize, r.y,
                    DnDTabbedPane.rwh + DnDTabbedPane.buttonsize, r.height);
            ...
            DnDTabbedPane.rForward.setBounds(r.x, r.y + r.height - DnDTabbedPane.rwh - DnDTabbedPane.buttonsize, r.width,
                    DnDTabbedPane.rwh + DnDTabbedPane.buttonsize);
        }
