...
public class ETextPane extends JTextPane implements EComponentI, ReadableComponent, ETextComponentI {
    protected static class BoldAction extends EComponentPopupMenuAction<ETextPane> {
        ...
        public void actionPerformed(ActionEvent e) {
            StyledEditorKit kit = delegate.getStyledEditorKit();
            MutableAttributeSet attr = kit.getInputAttributes();
            boolean bold = !StyleConstants.isBold(attr);
            StyleConstants.setBold(attr, bold);
            delegate.setCharacterAttributes(attr, false);
        }
    ...
    protected static class CenterJustifyAction extends EComponentPopupMenuAction<ETextPane> {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            delegate.setParagraphAttributes(attr, false);
        }
    ...
    protected static class FontAction extends EComponentPopupMenuAction<ETextPane> {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            Font font = EFontChooser.showDialog(getParentComponent());
            if (font == null) {
                return;
            }
            MutableAttributeSet attr = new SimpleAttributeSet();
    ...
    protected static class JustifyAction extends EComponentPopupMenuAction<ETextPane> {
        ...
        public JustifyAction(ETextPane component) {
            ...
            putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_J, Event.CTRL_MASK));
        }
    ...
    protected static class LeftJustifyAction extends EComponentPopupMenuAction<ETextPane> {
        ...
        public LeftJustifyAction(ETextPane component) {
            ...
            putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_L, Event.CTRL_MASK));
        }
    ...
    protected static class OpenAction extends EComponentPopupMenuAction<ETextPane> {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try (FileInputStream in = new FileInputStream(file)) {
                ...
                EditorKit kit = delegate.getEditorKit();
                kit.read(in, doc, 0);
                in.close();
    ...
    public String getFileExt() {
        String contentType = getEditorKit().getContentType();
    ...
    protected void installPopupMenuAction(EComponentPopupMenu popupMenu) {
        ...
        actions = new Action[] { new OpenAction(this), new SaveAction(this), new PrintAction(this), null, new FontAction(this), new BoldAction(this), new ItalicAction(this), new UnderlineAction(this), new JustifyAction(this), new LeftJustifyAction(this),
        ...
        while (iterator.hasNext()) {
            try {
                ...
                EComponentExporterAction<ETextPane> action = new EComponentExporterAction<>(exporter, this);
                popupMenu.add(action);
