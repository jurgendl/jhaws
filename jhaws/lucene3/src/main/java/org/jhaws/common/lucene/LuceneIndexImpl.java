...
public class LuceneIndexImpl implements LuceneInterface {
	 ...
	 */
	@Override
	public LuceneInterface index(String text, String title, String description, String... keywords) throws IOException, ConvertorNotSupportedException {
	 ...
	 */
	@Override
	public LuceneInterface index(URL url, String description, String... keywords) throws ProtocolException, ConvertorNotSupportedException, IOException {
