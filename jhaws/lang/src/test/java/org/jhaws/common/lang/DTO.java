...
public class DTO {
	...
	public String toString() {
		return new ToStringBuilder(this).appendSuper(super.toString()).append("veld1", veld1).append("veld2", veld2).append("veld3", veld3).append("nestedDTOVeld", nestedDTOVeld)
				.append("nestedDTO", nestedDTO).append("commonNested", commonNested).toString();
	}
