...
public class LambdaPathTest {
    @Test
    public void test() {
        LambdaPath<LambdaPathA, LambdaPathB> a = LambdaPath.p(LambdaPathA::getB);
        System.out.println(a);
        Assertions.assertEquals("b", a.getFullPath());
        try {
            LambdaPath<LambdaPathA, String> d = LambdaPath.p((LambdaPathA la) -> la.getB().getBs());
        ...
        LambdaPath<LambdaPathD, String> e = LambdaPath.p(LambdaPathD::getDs);
