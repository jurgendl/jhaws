 ...
 * @since 1.8
 */
public class RegexIterator implements EnhancedIterator<Match>, Match {
	...
	public String streamFunction(Function<Match, ?> converter) {
		return streamBiConsumer((match, buffer) -> RegexIterator.this.matcher.appendReplacement(buffer,
				toString(converter.apply(match))));
	}
