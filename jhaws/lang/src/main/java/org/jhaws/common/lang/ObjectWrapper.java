...
//	}
	...
	private static final Object cc_getValue(ClassCache cc, String fieldName, ObjectWrapper wrapper)
		...
		try {
			...
			if (finalf) {
				// ObjectWrapper.modifiersField.setInt(field, field.getModifiers() &
				// ~Modifier.FINAL);
			}
	...
	/**
	 * configureerbaar wat juist nodig is, subset wordt niet gecached (de volledige
	 * set wel) waardoor deze functie net iets trager is dan {@link #getFields()}
	 */
