 ...
 * their equivalent byte buffers or String objects<br>
 *
...
public class HexString {
	/**
	 * appends a hexadecimal representation of a particular char value to a string
	 * buffer, two hexadecimal digits are appended to the string
	 *
	 ...
	 * BigInteger. Each byte in the input array is converted to a two-digit
	 * hexadecimal value. Thus the returned string is twice the length of the input
	 * byte array. The output hex characters are upper case.
	 *
	 * @param bigInteger : BigInteger
	...
	/**
	 * Returns a string containing the hexadecimal representation of the input byte
	 * array. Each byte in the input array is converted to a two-digit hexadecimal
	 * value. Thus the returned string is twice the length of the input byte array.
	 * The output hex characters are upper case.
	 *
	 ...
	 * Returns a string containing the hexadecimal representation of the input byte
	 * array. Each byte in the input array is converted to a two-digit hexadecimal
	 * value. Thus the returned string is twice the length of the specified amount
	 * of the input byte array. The output hex characters are upper case.
	 *
	 * @param buffer      : byte[] : a buffer to convert to hex
	 * @param startOffset : int : the offset of the first byte in the buffer to
	 *                    process
	...
	/**
	 * converts a hexadecimal representation of a BigInteger back to it's original
	 * form (BigInteger)
	 *
	 ...
	 * hexadecimal string. That is, each pair of hexadecimal characters in the input
	 * string is decoded into the byte value that they represent, and that byte
	 * value is appended to a byte array which is ultimately returned. function
	 * doesn't care whether the hexadecimal characters are upper or lower case, and
	 * it also can handle odd-length hex strings by assuming a leading zero digit.
	 * If any character in the input string is not a valid hexadecimal digit, it
	 * throws a NumberFormatException, in keeping with the behavior of Java
	 * functions like Integer.parseInt().
	 *
	 * @param hexString : String : a string of hexadecimal characters
	 * @return : byte[] : a byte array built from the bytes indicated by the input
	 *         string
	...
	/**
	 * converts a hexadecimal string representing one byte (two hexadecimal
	 * characters) to that byte
	 *
	 ...
	 * hexadecimal string. That is, each pair of hexadecimal characters in the input
	 * string is decoded into the byte value that they represent, and that byte
	 * value is appended to a string which is ultimately returned. This function
	 * doesn't care whether the hexadecimal characters are upper or lower case, and
	 * it also can handle odd-length hex strings by assuming a leading zero digit.
	 * If any character in the input string is not a valid hexadecimal digit, it
	 * throws a NumberFormatException, in keeping with the behavior of Java
	 * functions like Integer.parseInt(). The conversion assumes the default
	 * charset; making the charset explicit could be accomplished by just adding a
	 * parameter here and passing it through to the String constructor.
	 *
	 * @param hexString : String : a string of hexadecimal characters
	 * @return : String : a String built from the bytes indicated by the input
	 *         string
	 */
	...
	/**
	 * prints the hex String to a easier to read text to the console with default 8
	 * hex characters per block and 4 blocks on a line, default separator is ' '
	 *
	 ...
	 *
	 * @param hexedString     : String : hex string
	 * @param hexPairsOnBlock : int : number of characters pairs in a block without
	 *                        block separator ' ' (will always be even)
	 * @param hexBlocksOnLine : int : number of blocks on a line without block
	 *                        separator '\n'
	 * @param separator       : String : separator string/character
	 * @param suffix          : String : suffix before each line
	 * @return : String : formatted hex string
	 */
	public static String printHexString(final String hexedString, int hexPairsOnBlock, final int hexBlocksOnLine,
	...
	/**
	 * <font color=red><b>DO NOT TOUCH THIS UNLESS YOU REALLY KNOW WHAT YOU ARE
	 * DOING</b></font>
	 *
	...
	/**
	 * Returns a string containing the hexadecimal repr esentation of the input
	 * string. Each byte in the input string is converted to a two-digit hexadecimal
	 * value. Thus the returned string is twice the length of the input string. The
	 * output hex characters are upper case. The conversion assumes the default
	 * charset; making the charset explicit could be accomplished by just adding a
	 * parameter here and passing it through to getBytes().
	 *
