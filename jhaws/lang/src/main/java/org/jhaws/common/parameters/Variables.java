...
public class Variables<T> {
        ...
        try {
            ...
            while (!queue.isEmpty()) {
                ...
                if (variable != null) {
                    ...
                    if (currentVariable == null) throw new PVException("parameter not processed: " + value);
    ...
    public Variables<T> log() {
        ...
        if (vars != null) IntStream.range(0, vars.size()).mapToObj(i -> "parameter " + (i + 1) + ": " + vars.get(i)).forEach(System.out::println);
        return this;
    }
