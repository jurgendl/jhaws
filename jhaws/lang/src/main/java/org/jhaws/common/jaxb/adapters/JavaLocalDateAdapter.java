...
public class JavaLocalDateAdapter extends XMLGregorianCalendarAdapter<LocalDate> {
    ...
    public XMLGregorianCalendar marshal(LocalDate v) throws Exception {
        ...
        return datatypeFactory.newXMLGregorianCalendar(v.getYear(), v.getMonthValue(), v.getDayOfMonth(), DatatypeConstants.FIELD_UNDEFINED, DatatypeConstants.FIELD_UNDEFINED, DatatypeConstants.FIELD_UNDEFINED, DatatypeConstants.FIELD_UNDEFINED,
