...
public class AbstractBatch implements Runnable {
    ...
    protected static BatchExecution<Runnable> step(BatchExecution<RunnableList> parent, String id, Supplier<String> supplyingAction, boolean throwsException) {
    ...
    protected static <R extends Runnable> BatchExecution<R> step(BatchExecution<RunnableList> parent, BatchStep step, R action, boolean throwsException) {
    ...
    protected static BatchExecution<Runnable> step(BatchExecution<RunnableList> parent, String id, boolean act, Supplier<String> supplyingAction, boolean throwsException) {
    ...
    protected static <C> BatchExecution<Runnable> step(C context, BatchExecution<RunnableList> parent, String id, boolean act, Consumer<C> supplyingAction, boolean throwsException) {
        return step(parent, id, act, () -> {
