...
public class JavaLocalDateTimeAdapter extends XMLGregorianCalendarAdapter<LocalDateTime> {
	...
	public XMLGregorianCalendar marshal(LocalDateTime v) throws Exception {
		...
		return datatypeFactory.newXMLGregorianCalendar(v.getYear(), v.getMonthValue(), v.getDayOfMonth(), v.getHour(),
				v.getMinute(), v.getSecond(), v.getNano() / 1000 / 1000, DatatypeConstants.FIELD_UNDEFINED);
	}
	...
	public LocalDateTime unmarshal(XMLGregorianCalendar v) throws Exception {
		...
		return LocalDateTime.of(v.getYear(), v.getMonth(), v.getDay(), v.getHour(), v.getMinute(), v.getSecond(),
