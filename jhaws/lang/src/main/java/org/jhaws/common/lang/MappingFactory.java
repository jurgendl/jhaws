...
public class MappingFactory {
    ...
    protected Map<String, Property<Object, Object>> info(Class<?> clazz) throws MappingException {
        if (!this.info.containsKey(clazz)) {
            try {
                Map<String, PropertyDescriptor> originalMap = streamArray(this.parallel, Introspector.getBeanInfo(clazz).getPropertyDescriptors()).filter((t) -> ((t.getWriteMethod() != null) && (t.getReadMethod() != null)))
