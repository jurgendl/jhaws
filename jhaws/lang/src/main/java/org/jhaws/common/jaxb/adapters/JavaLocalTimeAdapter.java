...
public class JavaLocalTimeAdapter extends XMLGregorianCalendarAdapter<LocalTime> {
	...
	public XMLGregorianCalendar marshal(LocalTime v) throws Exception {
		...
		return datatypeFactory.newXMLGregorianCalendar(DatatypeConstants.FIELD_UNDEFINED,
				DatatypeConstants.FIELD_UNDEFINED, DatatypeConstants.FIELD_UNDEFINED, v.getHour(), v.getMinute(),
				v.getSecond(), v.getNano() / 1000 / 1000, DatatypeConstants.FIELD_UNDEFINED);
	}
