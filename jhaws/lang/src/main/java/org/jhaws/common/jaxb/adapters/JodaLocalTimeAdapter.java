...
public class JodaLocalTimeAdapter extends XMLGregorianCalendarAdapter<LocalTime> {
	...
	public XMLGregorianCalendar marshal(LocalTime v) throws Exception {
		...
		return datatypeFactory.newXMLGregorianCalendar(DatatypeConstants.FIELD_UNDEFINED,
				DatatypeConstants.FIELD_UNDEFINED, DatatypeConstants.FIELD_UNDEFINED, v.getHourOfDay(),
				v.getMinuteOfHour(), v.getSecondOfMinute(), v.getMillisOfSecond(), DatatypeConstants.FIELD_UNDEFINED);
	}
