...
public class JodaLocalDateAdapter extends XMLGregorianCalendarAdapter<LocalDate> {
    ...
    public XMLGregorianCalendar marshal(LocalDate v) throws Exception {
        ...
        return datatypeFactory.newXMLGregorianCalendar(v.getYear(), v.getMonthOfYear(), v.getDayOfMonth(), DatatypeConstants.FIELD_UNDEFINED, DatatypeConstants.FIELD_UNDEFINED, DatatypeConstants.FIELD_UNDEFINED, DatatypeConstants.FIELD_UNDEFINED,
