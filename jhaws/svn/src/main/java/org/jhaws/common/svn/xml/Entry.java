...
public class Entry {
	...
	public String toString() {
		return "Entry [" + (path != null ? "path=" + path + ", " : "") + "revision=" + revision + ", " + (kind != null ? "kind=" + kind + ", " : "")
				+ (url != null ? "url=" + url + ", " : "") + (relativeUrl != null ? "relativeUrl=" + relativeUrl + ", " : "")
				+ (repository != null ? "repository=" + repository + ", " : "") + (name != null ? "name=" + name + ", " : "") + (wcInfo != null ? "wcInfo=" + wcInfo + ", " : "")
				+ (wcStatus != null ? "wcStatus=" + wcStatus + ", " : "") + (reposStatus != null ? "reposStatus=" + reposStatus + ", " : "")
