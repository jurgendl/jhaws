...
public class SvnExecTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("=========================");
            SvnList svn_ls = SvnExec.list(projectdir, svn_info.getEntry().getUrl().replace("trunk", "tags"));
            ...
            System.out.println("=========================");
            SvnList svn_ls_tag = SvnExec.list(projectdir, svn_info.getEntry().getUrl().replace("trunk", "tags"));
