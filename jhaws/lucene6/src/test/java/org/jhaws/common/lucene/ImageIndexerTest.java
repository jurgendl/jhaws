...
public class ImageIndexerTest {
    ...
    public void test() {
        ...
        results = new ImageIndexer().findDuplicatesExt(tmp.child("dubsindex"), Arrays.asList(tmp), xml, 5.0, Arrays.asList(CEDD.class, FCTH.class, EdgeHistogram.class, ColorLayout.class, ScalableColor.class, Tamura.class, Gabor.class));
        System.out.println("=========================");
    ...
    public static void main(String[] args) {
        ...
        ImageSimilarities results = new ImageIndexer().findDuplicatesExt(p.child("dubsindex"), Arrays.asList(p), xml, 5.0, Arrays.asList(CEDD.class, FCTH.class, EdgeHistogram.class, ColorLayout.class, ScalableColor.class, Tamura.class, Gabor.class));
        System.out.println("=========================");
        results.forEach(System.out::print);
        System.out.println("=========================");
    }
