...
public class PixelFormatFlagsType {
    ...
    public PixelFormatFlagsType withBigEndian(int value) {
        setBigEndian(value);
        return this;
    }

    public PixelFormatFlagsType withPalette(int value) {
        setPalette(value);
        return this;
    }

    public PixelFormatFlagsType withBitstream(int value) {
        setBitstream(value);
        return this;
    }

    public PixelFormatFlagsType withHwaccel(int value) {
        setHwaccel(value);
        return this;
    }

    public PixelFormatFlagsType withPlanar(int value) {
        setPlanar(value);
        return this;
    }

    public PixelFormatFlagsType withRgb(int value) {
        setRgb(value);
        return this;
    }

    public PixelFormatFlagsType withPseudopal(int value) {
        setPseudopal(value);
        return this;
    }

    public PixelFormatFlagsType withAlpha(int value) {
        setAlpha(value);
        return this;
    }
