...
public class YTDL extends Tool {
    ...
    public static class YTDLFormat implements Serializable {
        ...
        public String toString() {
            return "YTDLFormat [height=" + this.height + ", width=" + this.width + ", formatCode=" + this.formatCode + ", extension=" + this.extension + ", resolution=" + this.resolution + ", note=" + this.note + ", size=" + this.size + "]";
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (this.formatCode == null) {
                if (other.formatCode != null) return false;
            } else if (!this.formatCode.equals(other.formatCode)) return false;
            return true;
        }
    }
