...
public class HexString {
	 ...
	 * string buffer, two hexadecimal digits are appended to the string
	 *
	...
	/**
	 * converts a hexadecimal representation of a BigInteger back to it's
	 * original form (BigInteger)
	 *
	 ...
	 * byte value is appended to a byte array which is ultimately returned.
	 ...
	 *
	 * @return : byte[] : a byte array built from the bytes indicated by the
	 * input string
	 *
	...
	/**
	 * prints the hex String to a easier to read text to the console with
	 * default 8 hex characters per block and 4 blocks on a line, default
	 * separator is ' '
	 *
	 ...
	 *
	 * @param hexedString : String : hex string
	 * @param hexPairsOnBlock : int : number of characters pairs in a block
	 * without block separator ' ' (will always be even)
