...
public class ImageTools {
	 ...
	 *
	 * @param image : Image : source image
	 * @param flip : int : parameter : FLIP_VERTICALLY, FLIP_HORIZONTALLY or
	 ...
	 * @param source : BufferedImage : source image
	 * @param factor : double : scale factor (1.0 does not scale)
	 * @param hint : int : scale hint Image.SCALE_DEFAULT, Image.SCALE_FAST,
	 ...
	 *
	 * @param image : Image : image
	 * @param type : int : image type, use Image. ..., TYPE_INT_RGB,
	 * TYPE_INT_ARGB, TYPE_INT_ARGB_PRE, TYPE_INT_BGR, TYPE_3BYTE_BGR,
	 * TYPE_4BYTE_ABGR, TYPE_4BYTE_ABGR_PRE, TYPE_BYTE_GRAY, TYPE_USHORT_GRAY,
	 * TYPE_BYTE_BINARY, TYPE_BYTE_INDEXED, TYPE_USHORT_565_RGB or
	 * TYPE_USHORT_555_RGB
	 *
	 * @return : BufferedImage : buffered image
	 */
	 ...
	 *
	 * @param image : Image : source image (normally an RGB image but can by an
	 * RGBA image)
	 *
