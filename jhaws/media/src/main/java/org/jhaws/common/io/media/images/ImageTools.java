...
public class ImageTools {
     ...
     * @return a new compatible <code>BufferedImage</code> containing a thumbnail of <code>image</code>
     * @throws IllegalArgumentException if <code>newWidth</code> is larger than the width of <code>image</code> or if code>newHeight</code> is larger than the height of
     ...
     *
     * @param image : Image : image
     * @param type : int : image type, use Image. ..., TYPE_INT_RGB, TYPE_INT_ARGB, TYPE_INT_ARGB_PRE, TYPE_INT_BGR, TYPE_3BYTE_BGR, TYPE_4BYTE_ABGR, TYPE_4BYTE_ABGR_PRE,
