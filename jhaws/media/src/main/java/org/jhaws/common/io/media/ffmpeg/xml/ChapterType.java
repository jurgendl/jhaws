...
public class ChapterType {
    ...
    public ChapterType withId(int value) {
        setId(value);
        return this;
    }

    public ChapterType withTimeBase(String value) {
        setTimeBase(value);
        return this;
    }

    public ChapterType withStart(int value) {
        setStart(value);
        return this;
    }

    public ChapterType withStartTime(Float value) {
        setStartTime(value);
        return this;
    }

    public ChapterType withEnd(int value) {
        setEnd(value);
        return this;
    }

    public ChapterType withEndTime(float value) {
        setEndTime(value);
        return this;
    }
