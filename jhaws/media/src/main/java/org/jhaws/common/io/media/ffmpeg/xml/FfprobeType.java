...
public class FfprobeType {
    ...
    public FfprobeType withProgramVersion(ProgramVersionType value) {
        setProgramVersion(value);
        return this;
    }

    public FfprobeType withLibraryVersions(LibraryVersionsType value) {
        setLibraryVersions(value);
        return this;
    }

    public FfprobeType withPixelFormats(PixelFormatsType value) {
        setPixelFormats(value);
        return this;
    }

    public FfprobeType withPackets(PacketsType value) {
        setPackets(value);
        return this;
    }

    public FfprobeType withFrames(FramesType value) {
        setFrames(value);
        return this;
    }

    public FfprobeType withPacketsAndFrames(PacketsAndFramesType value) {
        setPacketsAndFrames(value);
        return this;
    }

    public FfprobeType withPrograms(ProgramsType value) {
        setPrograms(value);
        return this;
    }

    public FfprobeType withStreams(StreamsType value) {
        setStreams(value);
        return this;
    }

    public FfprobeType withChapters(ChaptersType value) {
        setChapters(value);
        return this;
    }

    public FfprobeType withFormat(FormatType value) {
        setFormat(value);
        return this;
    }

    public FfprobeType withError(ErrorType value) {
        setError(value);
        return this;
    }
