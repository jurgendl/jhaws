...
public class ImageFileFilter extends FileExtensionFilter {
    ...
    public ImageFileFilter(String description) {
        super(description, new String[] { "jpg", "jpeg", "bmp", "tiff", "tif", "pix", "png", "gif", "jp2", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
