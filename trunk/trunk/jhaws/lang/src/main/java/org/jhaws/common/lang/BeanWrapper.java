...
public class BeanWrapper {
     ...
     * {@link #getFields()}
     */
    public final Map<String, PropertyDescriptor> getFields(@SuppressWarnings("unused") boolean removeStatic,
            @SuppressWarnings("unused") boolean removeFinal, Class<?> exclusiveClass) {
        Map<String, PropertyDescriptor> map = new HashMap<String, PropertyDescriptor>();
