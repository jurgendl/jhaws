...
public class EncodingInfo {
    ...
    private static List<EncodingInfo> encodingList = new Vector<EncodingInfo>();

    static {
        EncodingInfo.encodingList.add(new EncodingInfo(null, "UTF-32, big-endian", new String(new byte[] { 0, 0, -2, -1 }))); // not supported by java, will throw UnsupportedEncodingException //$NON-NLS-1$ 
        EncodingInfo.encodingList.add(new EncodingInfo(null, "UTF-32, little-endian", new String(new byte[] { 0, 0, -1, -2 }))); // not supported by java, will throw UnsupportedEncodingException //$NON-NLS-1$ 
